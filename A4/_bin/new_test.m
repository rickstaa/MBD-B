...
Tqpqp = simplify(jacobian(Tqp,qp')); % coefficient of the ddq term.
Tqpq = simplify(jacobian(Tqp,q'))*qp; % convective terms
...
%% Express results back in  CM coordinates
